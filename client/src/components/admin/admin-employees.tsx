...
export function AdminEmployees() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (submitData.staffMemberId === 'none') {
      submitData.staffMemberId = null;
    }
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent className="bg-slate-700 border-slate-600">
                    ...
                    {editingEmployee?.staffMemberId && (
                      <SelectItem value={editingEmployee.staffMemberId} className="text-white hover:bg-slate-600">
                        {editingEmployee.staffMember?.name} - {editingEmployee.staffMember?.position}
                      </SelectItem>
                    )}
                  </SelectContent>
                </Select>
